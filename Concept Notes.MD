...
* Everything is an object means all objects can be assigned to variables, passed as arguments, or returned from functions. Most elements have attributes and methods that can be accessed using dot notation
